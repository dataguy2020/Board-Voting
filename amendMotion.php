...
if ($newmotiondesc != "") {
    ...
    elseif ($newmotiondesc != $existingmotiondec) {
        $updateMotion = $db_con->prepare("UPDATE motions SET motion_description=:description where motion_id=:motionid;");
        $updateMotion->execute(array(
        ...
        $dispo       = "AMENDED";
        $amendMotion = $db_con->prepare("UPDATE motions SET motion_disposition=:dispo where motions_id=:motionid;");
        $amendMotion->execute(array(
            ':dispo' => $dispo,
            ':motionid' => $motionid
        ));
        ...
        $insertChange = $db_con->prepare("INSERT INTO motionChangeLog
